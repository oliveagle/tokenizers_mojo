"""Load a TokenizerV3 from a JSON config."""
...
def from_pretrained_v3(path: String) raises -> TokenizerV3:
    ...
    if mtype != "BPE":
        raise Error("from_pretrained_v3: only BPE supported")
