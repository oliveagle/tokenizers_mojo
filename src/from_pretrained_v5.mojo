"""Load TokenizerV5 from JSON config."""
...
from bpe import BPE
from tokenizer_v5 import TokenizerV5
...
def from_pretrained_v5(path: String) raises -> TokenizerV5:
    ...
    if mtype != "BPE":
        raise Error("from_pretrained_v5: only BPE supported")
